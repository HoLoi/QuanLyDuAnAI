        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrainSize = table.Column<int>(type: "int", nullable: true),
                    TestSize = table.Column<int>(type: "int", nullable: true),
                    NgayTao = table.Column<DateTime>(type: "datetime2", nullable: true),
                    MoTaModel = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    LoaiModel = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SoDeXuatCongViecChoDuyet = table.Column<int>(type: "int", nullable: true),
                    SoDeXuatCongViecBiTuChoi = table.Column<int>(type: "int", nullable: true),
                    ThoiGianDuyetCongViecTrungBinh = table.Column<double>(type: "float", nullable: true),
                    SoDeXuatNganSachChoDuyet = table.Column<int>(type: "int", nullable: true),
                    SoDeXuatNganSachBiTuChoi = table.Column<int>(type: "int", nullable: true),
                    ThoiGianDuyetNganSachTrungBinh = table.Column<double>(type: "float", nullable: true),
                    SoBaoCaoTienDoChoDuyet = table.Column<int>(type: "int", nullable: true),
                    SoBaoCaoTienDoBiTuChoi = table.Column<int>(type: "int", nullable: true),
                    SoBaoCaoTienDoYeuCauBoSung = table.Column<int>(type: "int", nullable: true),
                    TyLeBaoCaoTienDoBiTuChoi = table.Column<double>(type: "float", nullable: true),
                    SoLanCapNhatTienDo = table.Column<int>(type: "int", nullable: true),
                    SoNgayChamCapNhatTienDo = table.Column<int>(type: "int", nullable: true),
                    LaDuAnTre = table.Column<bool>(type: "bit", nullable: true),
                    MaDMNguyenNhan = table.Column<int>(type: "int", nullable: true),
                    NgayTongHop = table.Column<DateTime>(type: "datetime2", nullable: true),
                    GhiChuDataset = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_AI_DATASET", x => x.MaData);
                    table.ForeignKey(
                        name: "FK_AI_DATASET_DM_NGUYEN_NHAN",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReasonSource = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    CanhBaoNguyenNhan = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNguoiDungXacNhan = table.Column<int>(type: "int", nullable: true),
                    GhiChuXacNhan = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<int>(type: "int", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NgayHoanThanhThucTeDuAn = table.Column<DateTime>(type: "datetime2(7)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TrangThaiDanhGiaDA = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MaNguoiDungDuyet = table.Column<int>(type: "int", nullable: true),
                    NgayDuyetDanhGiaDA = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LyDoTuChoiDanhGiaDA = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<int>(type: "int", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NhanXetTongQuanNV = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    TrangThaiDanhGiaNV = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: true),
                    MaNguoiDungDuyet = table.Column<int>(type: "int", nullable: true),
                    NgayDuyetDanhGiaNV = table.Column<DateTime>(type: "datetime2", nullable: true),
                    LyDoTuChoiDanhGiaNV = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: true),
                    DeletedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    DeletedBy = table.Column<int>(type: "int", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaChiTietDGDA = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    MaDanhGiaDuAn = table.Column<int>(type: "int", nullable: false),
                    MaTieuChi = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AI_DATASET_MaDMNguyenNhan",
                table: "AI_DATASET",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CT_DANH_GIA_DU_AN_MaTieuChi",
                table: "CT_DANH_GIA_DU_AN",
                column: "MaTieuChi");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CT_DANH_GIA_NHAN_VIEN_MaTieuChi",
                table: "CT_DANH_GIA_NHAN_VIEN",
                column: "MaTieuChi");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DANH_GIA_DU_AN_MaNguoiDungDuyet",
                table: "DANH_GIA_DU_AN",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DANH_GIA_NHAN_VIEN_MaNguoiDungDuyet",
                table: "DANH_GIA_NHAN_VIEN",
                column: "MaNguoiDungDuyet");
